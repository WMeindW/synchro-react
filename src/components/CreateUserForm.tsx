...
export default function CreateUserForm() {
    ...
    return (
        <form className={"container-form"} onSubmit={handleSubmit}>
            ...
            <input required={true} placeholder={"Username"} type="text" id="username" onChange={handleChange} name="username" />

            <input required={true} placeholder={"Phone"} type="tel" id="phone" name="phone" onChange={handleChange} />

            <input required={true} placeholder={"Email"} type="email" id="email" name="email" onChange={handleChange}
                   />

            <input required={true} placeholder={"Password"} type="password" id="password" name="password" onChange={handleChange}
                   />
